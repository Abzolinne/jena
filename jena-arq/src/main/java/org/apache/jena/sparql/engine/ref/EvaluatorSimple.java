...
public class EvaluatorSimple implements Evaluator {
    ...
    public Table pathPattern(TriplePath triplePath) {
        // Shudder - this may well be expensive, but this is the simple evaluator,
        // written for correctness.
    ...
    private Table minusWorker(Table tableLeft, Table tableRight) {
        // Minus(Ω1, Ω2) = { μ | μ in Ω1 such that for all μ' in Ω2, either μ and μ'
        // are not compatible or dom(μ) and dom(μ') are disjoint }
