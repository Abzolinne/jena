...
public class Syntax extends Symbol {
    ...
    public static final Syntax syntaxSPARQL_11_sim = new Syntax("http://sj.dcc.uchile.cl/SPARQL_11_sim");
    ...
    public static Syntax make(String uri) {
        ...
        if ( sym.equals(syntaxSPARQL_11_sim) )  
            return syntaxSPARQL_11_sim ;
        if ( sym.equals(syntaxSPARQL_11) )
